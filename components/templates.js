...
export default function Templates({ content, title }) {
    // const
    ...
    useEffect(() => {
        ...
        const fsession = JSON.stringify(session);
        console.log(fsession);
        
        const parsed = JSON.parse(fsession);
        const username = setUsername(parsed.username);
    ...
    return (
        <>
            ...
            <div className="wrapper">
                ...
                <div className="content-wrapper" style={{ minHeight: "1302.32px" }}>
                    <section className="content-header">
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1>{title ? title : 'Administrator'}</h1>
                                </div>
                                <div className="col-sm-6">
